        ...
        <div class="card">
            <div class="card-header card-header-primary text-center">
                ...
                <img class="img-thumbnail"
                    src="https://res.cloudinary.com/ddnbnbb5i/image/upload/v1679601452/Captura_de_pantalla_2023-03-18_102440_j7ge9j.png"
                    width="150" />
            </div>
                ...
                <form action="" method="post" class="p-3">
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control form-control-lg text-center"
                            id="exampleInputPassword1" placeholder="Clave" name="clave">
                    </div>
                    <div class="mt-3">
